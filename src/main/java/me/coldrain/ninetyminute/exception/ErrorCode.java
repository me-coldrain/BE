...
public enum ErrorCode {
    SingUpDataValidException (400, "회원가입 양식을 확인해 주세요.", HttpStatus.BAD_REQUEST),
    ...
    ExpiredJwtException(444, "Access 토큰이 만료되었습니다. Refresh 토큰으로 Access 토큰을 재발급 해주세요.", HttpStatus.UNAUTHORIZED),
